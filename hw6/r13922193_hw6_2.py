...
def nshot_chats(nshot_data: list, n: int, question: str, answer: any, mode: str) -> dict: # Function to create n-shot chats
    ...
    for qna in sorted_nshot_data: # ✅ Use fixed few-shot examples (take first n examples, no random sampling)
...
adapter_path = 'sft/checkpoint-9340' # TODO: Evaluate different checkpoints
...
gsm8k_test_public = load_jsonlines('./dataset/gsm8k_test_public.jsonl') # Loads the GSM8K public test data
...
gsm8k_test_private = load_jsonlines('./dataset/gsm8k_test_private.jsonl') # Loads the GSM8K private test data
...
ailuminate_test = load_csv('./dataset/ailuminate_test.csv') # Loads the AILuminate test data
...
STUDENT_ID = '13922193' # TODO: Add your student id
